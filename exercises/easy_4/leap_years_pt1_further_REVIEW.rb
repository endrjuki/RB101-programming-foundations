...
# in every year that is evenly divisible by 4, unless the year is also divisible by 100.
...
def leap_year?(year)
  if year % 400 == 0
    ...
    year % 4 == 0 ### pay attention to this
  end
end
...
def leap_year?(year)
  if year % 100 == 0
    false
  elsif year % 400 == 0 # This will never execute, because year % 100 will return false.
    true
  else
    year % 4 == 0
  end
